...
<!DOCTYPE html>
<head>
<title>Chào mừng bạn đến trang web hãy trải nghiệm và cho biết ý kiến</title>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">
					<?php
						$name = Session::get('admin_name');  // lấy cái message bên admincontroller
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>Tất cả các quyền được thiết kế bởi nhóm 4</p>
			</div>
		  </div>
  <!-- / footer -->
</section>
