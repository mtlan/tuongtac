...
<div class="w3layouts-main">
	...
	?>
		<!-- admin-dashboard hàm này thực chất là gửi tới hàm mặc định sẽ lấy email và pass và sau đó so sánh tbl_admin -->
		<form action="{{URL::TO('admin-dashboard')}}" method="post">
		<!-- trường token mysql enject bảo mật cho việc gửi form-->
			{{ csrf_field() }} <!-- nó sẽ tự động cho input hidden name token ngẫu nhiên, bảo mật form-->
		...
		<p>Bạn không có tài khoản ? <a href="registration.html"> Hãy tạo tài khoản</a></p>
</div>
</div>
