        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    @foreach($all_cate as $key => $cate_pro)  {{-- all_pro bên CategoryProduct.php --}}
                    <tr>
                        ...
                        <td><span class="text-ellipsis">
                                ...
                                ?>
                                        {{-- echo 'Ẩn'; --}}
                                        {{-- lỗi echo '<a href=".{{URL::to('/unactive-category-product')}}."><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>'; --}}
